...
// Componente principal que gestiona qué pantalla mostrar según el estado
export default class Menu extends Component {
    state = {
        muestraLogin: true,      // Muestra la pantalla de Login inicialmente
        muestraregistro: false,  // Pantalla de Registro de usuarios
        muestraDashboard: false, // Pantalla de Dashboard
        muestraTickets: false,   // Pantalla de lista de tickets
        muestraTicketView: false,// Pantalla de detalle de ticket
        token: "",
        ticketId: null
    };
